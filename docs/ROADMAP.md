...
- [x] 모든 v2 기능이 통합 환경에서 의도대로 동작
- [x] Lighthouse Performance/Accessibility/Best Practices/SEO 모두 90+ 유지
- [x] 번들 크기 증가율이 기준(+20%) 이내
- [x] 프로덕션 URL에서 모든 신규 기능 동작 확인
- [x] `npm run check-all` 및 `npm run build` 최종 통과
